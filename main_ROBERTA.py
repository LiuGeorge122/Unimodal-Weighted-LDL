...
model = RobertaForSequenceClassification.from_pretrained(local_model_dir, num_labels=3).to(device)
...
def run_multiple_experiments(model_class, train_dataloader, test_dataloader, train_dataset, test_dataset,
                             compute_ece, test_texts, device, num_runs, epochs, learning_rate,
                             loss_fn):
